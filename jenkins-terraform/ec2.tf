# locals {
#   hostname = substr(sha256("Hellomyworldhowareyou:ponyo"),-10,-1)
# }
...
#     wopi_enabled = var.wopi_enabled || var.dedicated_wopi ? true : false
#     wopi_url = length(var.wopi_url) > 0 ? var.wopi_url : var.dedicated_wopi ? module.wopi[0].wopi_url : "https://${local.hostname}.wopi.securecircle.com"
